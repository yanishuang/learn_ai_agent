...
| Pydantic AI 2.x | Typed Python agent framework | Stable | Optional: evaluate only after the course `ModelGateway` and `RunContext` boundaries are in place; use a patched v2 release rather than carrying forward the former v2 beta assumption. | 2026-07-11 | [v2.9.0 is the latest release and v1.107.1 is the patched v1 line as of this verification](https://github.com/pydantic/pydantic-ai/releases) |
...
| Google ADK Python 1.0 | Google Python agent-development framework; A2A support is documented separately for Python, Go, and Java | Stable | Optional framework evaluation. ADK's A2A integration is explicitly Experimental and remains an optional course extension despite having exposing/consuming quickstarts. | 2026-07-11 | [Google announcement of Python ADK v1.0.0 stable](https://developers.googleblog.com/en/agents-adk-agent-engine-a2a-enhancements-google-io/) and [ADK A2A support, Experimental label, and language quickstarts](https://adk.dev/a2a/) |
